package org.snow2code.plugin.playerleashing.technologic;
...
public class LeashMain implements LeashSystem {
    ...
    public void start()
    {
        SemiLogger.Log("Start Technologic Leash (which is default)");
    }

    @Override
    public void stop()
    {
        SemiLogger.Log("Stop Technologic Leash (which is default)");
    }
}
/*
